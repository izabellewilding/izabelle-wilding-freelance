      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-lg text-gray-600 mb-6 font-body">
            I specialize in building beautiful, SEO friendly websites that are
          ...
          <p className="text-lg text-gray-600 font-body">
            My passion is to help people level up their online presence and grow
            their businesses. I am always looking for oppotunities, no matter
            how big or small, to help people achieve their goals.
          </p>
        </div>
      </div>
    </section>
